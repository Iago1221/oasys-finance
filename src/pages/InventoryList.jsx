...
const InventoryList = () => {
    ...
    const products = [
        { id: 1, name: 'Pro Watch Series X', sku: 'PW-992-B', category: 'Eletrônicos', balance: 145, unit: 'uni', image: 'https://ui-avatars.com/api/?name=Watch&background=137fec&color=fff' },
        { id: 2, name: 'Fone Audio-Z', sku: 'AZ-440-S', category: 'Áudio', balance: 88, unit: 'uni', image: 'https://ui-avatars.com/api/?name=Headset&background=0bda5b&color=fff' },
        { id: 3, name: 'MacBook Pro M2', sku: 'MB-221-M', category: 'Computadores', balance: 12, unit: 'un', image: 'https://ui-avatars.com/api/?name=Laptop&background=fa6238&color=fff' },
        { id: 4, name: 'Carregador Turbo 20W', sku: 'CH-20W-L', category: 'Acessórios', balance: 450, unit: 'un', image: 'https://ui-avatars.com/api/?name=Power&background=7c3aed&color=fff' },
        { id: 5, name: 'Cabo USB-C 2m', sku: 'CB-USC-2', category: 'Acessórios', balance: 920, unit: 'un', image: 'https://ui-avatars.com/api/?name=Cable&background=137fec&color=fff' },
        { id: 6, name: 'Teclado Mecânico RGB', sku: 'KB-RGB-MK', category: 'Periféricos', balance: 24, unit: 'un', image: 'https://ui-avatars.com/api/?name=Keys&background=0bda5b&color=fff' },
    ];
