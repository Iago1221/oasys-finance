...
const PendingActivities = () => {
    ...
    const activities = [
        { id: 1, title: 'Aprovar Folha de Pagamento', category: 'Financeiro', deadline: 'Hoje', priority: 'Alta', color: 'red', description: 'Revisão final da folha de pagamento dos colaboradores referente ao mês 02/2026.' },
        { id: 2, title: 'Reposição de Estoque - Armazém A', category: 'Estoque', deadline: 'Amanhã', priority: 'Média', color: 'amber', description: 'Solicitar 200 unidades do SKU #3342 para evitar ruptura de estoque no armazém central.' },
        { id: 3, title: 'Conciliação Bancária Itaú', category: 'Financeiro', deadline: 'Ontem', priority: 'Alta', color: 'red', description: '32 transações pendentes de conciliação no extrato bancário.' },
        { id: 4, title: 'Atualizar Preços de Venda', category: 'Vendas', deadline: '07/03', priority: 'Baixa', color: 'blue', description: 'Reajustar tabela de preços conforme novos custos de importação.' },
        { id: 5, title: 'Manutenção Servidor Interno', category: 'TI', deadline: '10/03', priority: 'Média', color: 'slate', description: 'Backup preventivo e atualização de segurança do servidor de arquivos.' },
    ];
