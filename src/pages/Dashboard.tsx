...
import { useIntegrationsReadOnly } from '../hooks';

const Dashboard = () => {
    const navigate = useNavigate();
    const { isCRMActive } = useIntegrationsReadOnly();
                        ...
                        {isCRMActive && (
                            <div className="min-w-[160px] flex-1 bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-[10px] font-bold uppercase text-slate-500 dark:text-slate-400">Oportunidades Abertas</span>
                                </div>
