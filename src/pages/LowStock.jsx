...
const LowStock = () => {
    ...
    const lowStockItems = [
        { id: 1, name: 'Pro Watch Series X', sku: 'PW-992-B', current: 2, min: 15, level: 'Crítico', color: 'red', image: 'https://ui-avatars.com/api/?name=Watch&background=ef4444&color=fff' },
        { id: 2, name: 'Fone Audio-Z', sku: 'AZ-440-S', current: 5, min: 20, level: 'Crítico', color: 'red', image: 'https://ui-avatars.com/api/?name=Headset&background=ef4444&color=fff' },
        { id: 3, name: 'Cabo USB-C 2m', sku: 'CB-USC-2', current: 18, min: 50, level: 'Alerta', color: 'yellow', image: 'https://ui-avatars.com/api/?name=Cable&background=eab308&color=fff' },
        { id: 4, name: 'Carregador Turbo 20W', sku: 'CH-20W-L', current: 25, min: 40, level: 'Alerta', color: 'yellow', image: 'https://ui-avatars.com/api/?name=Power&background=eab308&color=fff' },
    ];
